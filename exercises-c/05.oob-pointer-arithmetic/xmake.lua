...
on_run(function (target)
    ...
    local rundir = "../../submit-riscv/exercises-c/05.oob-pointer-arithmetic/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
...
local args = {
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit-riscv/exercises-c/05.oob-pointer-arithmetic/debug"
