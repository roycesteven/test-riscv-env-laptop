...
on_run(function (target)
    ...
    local rundir = "../../submit-riscv/exercises-c++/08.type-confusion/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit-riscv/exercises-c++/08.type-confusion/debug"
