...
set_project("stack-buffer-over-write")
set_version("1.0.0")
...
target("stack-buffer-over-write")
    set_kind("binary")
...
on_run(function (target)
    ...
    local rundir = "../../submit-riscv/exercises-c++/04.stack-buffer-over-write/runs/run_" .. os.date("%Y%m%d_%H%M%S")
    os.mkdir(rundir)
    ...
    if get_config("debug_run") == true then
        ...
        local log_file = "../../submit-riscv/exercises-c++/04.stack-buffer-over-write/debug"
